...
///bài 12 ///file nhận xử lý data //của mục bài viết //ứng $tab=posts và $ac=add,edit/id
    ...
    if (isset($_POST['action']))
    {
        ...
        if ($action == 'add_post')
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    // $data_current lấy từ file init.php
                    //$data_user[id_acc] chính là id của tài khoản admin ta đang đăng nhập
        ...
        else if ($action == 'search_post')
        {
            ...
            if ($kw_search_post != '')
            {
                ...
                //tìm bằng id và title và slug nhé
                $sql_search_post = "SELECT * FROM posts WHERE 
                    id_post LIKE '%$kw_search_post%' OR
                    title LIKE '%$kw_search_post%' OR
                    slug LIKE '%$kw_search_post%'
