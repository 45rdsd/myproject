<?php
 ...
 //bài 6//FILE NÀY ĐỂ NHẬN VÀ XỬ LÝ DỮ LIỆU ĐĂNG NHẬP
// Kết nối database và lấy thông tin chung
require_once 'core/init.php';
 
// Nếu có tồn tại phương thức post
if (isset($_POST['user_signin']) && isset($_POST['pass_signin']))
{
    // Xử lý các giá trị được lấy từ các phương thức POST//Hàm htmlspecialchars có tác dụng tương tự với hàm htmlentities.
    ...
    else
    {
        ...
        {
            $pass_signin = md5($pass_signin);//kiểm tra xem có khớp với password trong database
