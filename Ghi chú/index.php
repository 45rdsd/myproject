...
if ($user)
{
	...
	if (isset($_GET['ac']))//ac có 1 trong những giá trị đặc biệt 
	{
		// Xử lý chuỗi $ac
		...
		else if ($ac == 'edit_note')
		{
         ...
         //kiểm tra xem có note nào là note có id_note bằng với $get_it  của user đang login hay ko.
					// Lệnh truy vấn kiểm tra sự tồn tại và quyền sở hữu note 

      ///kiểm tra xem id lấy được bằng phương thức GET từ url có là của bản note nào(của user đang login) hay ko//nếu có thì mới chuyển sang file edit-note
						...
						echo '
							<div class="container">
								<div class="alert alert-danger">
									Note này không tồn tại hoặc không thuộc quyền sở hữu của bạn_index nhé.
								</div>
							</div>
						';
					}					
